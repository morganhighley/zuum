...
namespace SecuritySystem_Crestron_SampleDriverModel_IP
{
	public class SecuritySystemProtocol : ABaseDriverProtocol, IDisposable
	{
		...
		/// <summary>
		/// This method will be called as a part of data hanlder method and receive the data
		/// This method will de construct the received data by command group 
		/// This information will be listend by security system and update the state of the system accordingly
		/// </summary>
		...
		{
			CommandSet command = BuildCommand(StandardCommandsEnum.DisarmResource, CommonCommandGroupType.Disarm, CommandPriority.High, "Disarm");
			if (command != null)
			{
				SendCommand(command);
			}
